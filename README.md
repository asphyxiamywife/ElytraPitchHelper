[modrinth page](https://modrinth.com/mod/elytrapitchhelper) (and [github actions](https://github.com/asphyxiamywife/ElytraPitchHelper/actions)) are the only officially maintained places to download
