...
final class ConfigScreenSaveController {
    ...
    void leaveAfterSaving() {
        if (!ownsCurrentStore()) {
            ...
            if (minecraft == null || minecraft.screen == host) {
    ...
    private void openConflictConfirmation(ConfigConflictException conflict) {
        ...
        minecraft.setScreen(new ConfigConflictScreen(diffs, keepInGameChanges -> {
            conflictConfirmationOpen = false;
            if (!ownsCurrentStore()) {
                return;
            }
            minecraft.setScreen((ConfigScreen) host);
    ...
    private void presentSaveFailure(ConfigSaveException failure) {
        ...
        minecraft.setScreen(new ConfigSaveFailureScreen(
