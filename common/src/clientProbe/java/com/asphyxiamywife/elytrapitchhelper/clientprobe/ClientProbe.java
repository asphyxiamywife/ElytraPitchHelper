    ...
    public static void frame() {
        ...
        try {
            ...
            if (now - lastProgress > 10_000_000_000L) {
                lastProgress = now;
                System.out.println("EPH client probe: screen=" + (client.screen == null ? "none" : client.screen.getClass().getSimpleName())
            ...
            if (!opening) {
                ...
                if (client.screen != null && client.screen.getClass().getSimpleName().equals("AccessibilityOnboardingScreen")) {
